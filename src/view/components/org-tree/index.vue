...
<script>
  import {getRenInfo,delRenInfo,queryRedis,getRenInfoFromCache,delCache,setRedisSwitch,editRenInfo} from '@/api/data'
  export default {
    data() {
      return {
        show: false,
        ...
        isUpdate:false,
        loading: true,
        switchBHRenInfo:false,
        switchCPICRasks:false,
        switchCPICRenInfo:false,
        switchPingAnRenInfo:false,
        switchRedis:false,
        switchRenInfo:false,
        switchRenInfoCar:false,
        tableColumn: [
          {
            title: '服务名称',
            key: 'vc2RouteName'
